...
path='/home/thomas/Documents/stanford/libraries/pbrt-v3-spectral/scenes/chessset/renderings/fisheye.dat';

oiPoly = piDat2ISET(path, 'wave', 400:10:700, 'recipe', thisR);
oiPoly.name ='lens'

oiWindow(oiPoly);
oiSet(oiPoly,'gamma',0.7)
Dlens=oiPoly.data.photons;
pause(1);
ax = gca;
exportgraphics(ax,'./fig/lens-fisheye.png')

%% Blackbox example


path='/home/thomas/Documents/stanford/libraries/pbrt-v3-spectral/scenes/chessset/renderings/dgausslens-blackbox.dat';
oiPoly = piDat2ISET(path, 'wave', 400:10:700, 'recipe', thisR);
