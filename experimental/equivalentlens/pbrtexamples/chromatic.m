...
%%  AChromatic Lens example


path='/home/thomas/Documents/stanford/libraries/pbrt-v3-spectral/scenes/simpleScene/renderings/achromatic-lens.dat';
...
pause(1);
ax = gca;
exportgraphics(ax,'./fig/lens-dgauss-achromat.png')
%%  Chromatic Lens example


path='/home/thomas/Documents/stanford/libraries/pbrt-v3-spectral/scenes/simpleScene/renderings/chromatic-lens.dat';
%path='/home/thomas/Documents/stanford/libraries/pbrt-v3-spectral/scenes/flatSurface/renderings/lens.dat'
%path='/home/thomas/Documents/stanford/libraries/pbrt-v3-spectral/scenes/simpleScene/renderings/scene-lens-512-diag2.dat'
oiPoly = piDat2ISET(path, 'wave', 400:10:700, 'recipe', thisR);
oiPoly.name ='lens chromat'
...
path='/home/thomas/Documents/stanford/libraries/pbrt-v3-spectral/scenes/simpleScene/renderings/chromatic-rtf.dat';
oiPoly = piDat2ISET(path, 'wave', 400:10:700, 'recipe', thisR);
...
pause(1);
ax = gca;
exportgraphics(ax,'./fig/rtf-dgauss-chromat.png')
