...
% Top
position_selection=[4]; % Choose the positions for which the top circle is unaffected by vignetting.
...
circleRadii = [radius_entrance radius_bottom radius_top  radius_3 ]
circleSensitivities = [sensitivity_entrance sensitivity_bottom sensitivity_top  sensitivity_3]
circlePlaneZ=entrancepupil_distance


                circleRadii= [ circleRadii 7.8000 ]
        circleSensitivities= [ circleSensitivities 0.1072 ]
