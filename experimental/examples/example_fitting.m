...
%% Sampling options 
spatial_nbSamples = 40; % Spatial sampling of [0,radius] domain
phi_nbSamples = 40; % Uniform sampling of the azimuth angle 
theta_max = 50; % maximal polar angle of incident ray - should be saved
theta_nbSamples = 50; %uniform sampling polar angle range
...
[input,output,planes] = raytraceLightField(lensR,spatial_nbSamples,...
    theta_max,theta_nbSamples,phi_nbSamples,offset, 'visualize', false);
...
%% Creat eJson File
% Generate absolute positions of the planes

% Save polynomial model in mat file
polyModel=poly;
save('poly.mat','polyModel')
file=fullfile('/home/thomas/Documents/stanford/libraries/iset/isetlens/scripts/equivalentlens/poly.mat');
jPath=polyJsonGenerate(file,'planes',planes,'outpath','polyjson-4deg.json')
