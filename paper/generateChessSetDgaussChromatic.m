...
thisR=piRecipeDefault('scenename','checkerboard')
%% Set camera position
...
rtffile=['dgauss28deg-zemax-poly6-chromatic-raytransfer.json'];
...
thisR.set('film diagonal',100,'mm');
resolution=300;
...
thisR.integrator.numCABands.value = 2
