...
cameras={};
for degree=[8]
    label{degree}=['inversetelephoto-polydeg' num2str(degree)]
    filename=['inversetelephoto-zemax-poly' num2str(degree) '-raytransfer.json']
...
relativeIllum.lens= 'inversetelephoto'
