%% Generate RTF without sparsity optimization
% THe goal is to see whether the polynomial converges better
...
lensName='tessar-notsparse-zemax'
...
%X=dlmread(['/home/thomas42/Downloads/tessar-rayaim-novignetfactors-aperture4.txt'],'\s',1); offset_sensorside=0.01; offset_objectside=0.01; %%mm
...
rtf=generateRTFfromIO(lensName,rtfName,iRays,oRays,offset_sensorside,offset_objectside,lensThickness,...
    ...
    'intersectionplanedistance',17,'sparsitytolerance',sparsitytolerance);
end