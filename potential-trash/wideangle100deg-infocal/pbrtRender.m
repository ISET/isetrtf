...
filmdistance_mm=1.061
sensordiagonal_mm=1.5;
...
cameras={};
for degree=[10 6]
    label{degree}=['wideangle100deg-polydeg' num2str(degree)]
    filename=['wideangle100deg-zemax-poly' num2str(degree) '-raytransfer.json']
