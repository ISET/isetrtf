...
filmdistance_mm=1.062+0.001; sensordiagonal_mm=1.5*1.5;

%filmdistance_mm=1.062; sensordiagonal_mm=1.5*1.5;
...
cameras={};
for degree=[8]
    label{degree}=['wideangle100deg-infocal-polydeg' num2str(degree)]
    filename=['wideangle100deg-infocal-zemax-poly' num2str(degree) '-raytransfer.json']
...
relativeIllum.lens= 'wideangle100deg';
...
% Comparison with relilum fucr from reverse lens
