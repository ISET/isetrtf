...
filmdistance_mm=2.003+0.0005;   %% Add offset to avoid issue with filmdistance = inputoffset
sensordiagonal_mm=5;
...
cameras={};
for degree=[8]
    label{degree}=['wideangle200deg-circle-polydeg' num2str(degree)]
    filename=['wideangle200deg-circle-zemax-poly' num2str(degree) '-raytransfer.json']
...
relativeIllum.lens= 'wideangle200deg';
relativeIllum.pbrt.x=xaxis;
relativeIllum.pbrt.y=maxnorm((relativeIllumPBRT));
