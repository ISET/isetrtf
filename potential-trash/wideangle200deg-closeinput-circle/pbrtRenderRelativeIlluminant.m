...
cameras={};
for degree=[8]
    label{degree}=['wideangle200deg-polydeg' num2str(degree)]
    filename=['wideangle200deg-zemax-poly' num2str(degree) '-raytransfer.json']
...
load relativeillum-zemax-1.85mm.mat
maxnorm= @(x)x/max(x)
figure; hold on    
